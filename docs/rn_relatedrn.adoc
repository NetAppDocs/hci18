...
* https://library.netapp.com/ecm/ecm_download_file/ECMLPxxxxxxx[vCenter Plug-in 4.9 Release Notes^]
...
== Compute firmware
* link:rn_compute_firmware_2.146.html[Compute Firmware Bundle 2.146 Release Notes^] _latest_
...
== Storage firmware
* link:rn_storage_firmware_2.146.html[Storage Firmware Bundle 2.146 Release Notes^] _latest_
