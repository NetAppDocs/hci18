...
----
. If the versions do not match, you should upgrade the OS. See the link:See the link:https://community.mellanox.com/s/article/howto-upgrade-switch-os-software-on-mellanox-switch-systems[Mellanox software Upgrade Guide^] for details.

== Configure the replacement switch
Perform the steps to configure the replacement switch. See link:See link:https://docs.mellanox.com/display/MLNXOSv381000/Configuration+Management[Mellanox configuration management^] for details.
