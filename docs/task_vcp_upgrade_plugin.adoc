...
* You are upgrading to Element Plug-in for vCenter Server 4.8, 4.7, 4.6, 4.5, or 4.4.
...
After you upgrade to VCP 4.8 or later with VMware vCenter Server 6.7U1, if the storage clusters are not listed or a server error appears in the *Clusters* and *QoSSIOC Settings* sections of the NetApp Element Configuration, see https://review.docs.netapp.com/us-en/vcp_2.19_vcp4.8_release_vcp_repo/vcp_reference_troubleshoot_vcp.html#errors-after-vcp-4-8-upgrade-with-vmware-vcenter-server-6-7u1[Element Plug-in for vCenter Server] documentation about troubleshooting these errors.
====
